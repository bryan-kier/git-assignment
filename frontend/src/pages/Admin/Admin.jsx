...
const stats = [
  { label: 'Revenue Today', value: formatPHP(18450) },
  { label: 'Orders Pending', value: '6' },
  { label: 'Low Stock Items', value: products.filter((p) => p.stock === 'low').length.toString() },
  { label: 'Pre-Orders Open', value: products.filter((p) => p.stock === 'preorder').length.toString() },
];
